...
public class App {
    public static void main(String[] args) {
        var ss = Arrays.stream(input().split("\n")).toList();
        ...
        var inMem = ss.stream()
                ...
                .reduce(0, Integer::sum);
        System.out.println("1: " + (inCode-inMem));
// 1:  (1375 fail) 1371

        var inCodePart2 = ss.stream()
                .map(App::countCharactersInCodePart2)
                .reduce(0, Integer::sum);
        System.out.println("2: " + (inCodePart2 - inCode));
// 2: 2117

    }

     static int countCharactersInCodePart2(String s) {
         var s1 = s.replaceAll("^\"|\"$", "***")
                 .replaceAll("\\\\x[a-f0-9]{2}", "*****")
                 .replaceAll("\\\\\"", "****")
                 .replaceAll("\\\\\\\\", "****");
         System.out.println("countCharactersInCodePart2 " + s1);
         return  s1.getBytes(StandardCharsets.UTF_8).length;
    }

    public static int countCharactersInMemory(String s) {
        var s1 = s.replaceAll("^\"|\"$", "")
                .replaceAll("\\\\x[a-f0-9]{2}", "*")
                .replaceAll("\\\\\"","*")
                .replaceAll("\\\\\\\\","*");
    ...
    public static int countCharactersInCode(String s) {
